...
export default function SubsidiesPage() {
  ...
  const categoryColors = {
    ...
    生活支援: "bg-green-100 text-green-800",
    交通: "bg-purple-100 text-purple-800",
    医療: "bg-red-100 text-red-800",
  }

  const statusColors = {
    申請可能: "bg-green-100 text-green-800",
    ...
    <div className="min-h-screen bg-gray-50 pb-20">
      <div className="p-4 space-y-6">
        ...
        <div className="text-center py-4">
          <h1 className="text-2xl font-bold text-gray-900">補助金情報</h1>
          <p className="text-gray-600 text-sm">使える補助金をチェックしよう</p>
        </div>
          ...
          <CardContent className="p-4 space-y-4">
            <div className="flex gap-2">
              <div className="flex-1">
                <Input placeholder="補助金を検索..." className="w-full" />
              </div>
        ...
        <Card className="bg-yellow-50 border border-yellow-200 shadow-sm">
          <CardContent className="p-4">
            <div className="flex items-center justify-between">
              <div>
                <h3 className="font-bold text-gray-900">プロフィール設定</h3>
        ...
        <div className="space-y-4">
          <h2 className="text-lg font-bold text-gray-800">利用可能な補助金</h2>
              ...
              <CardContent className="space-y-4">
                ...
                <div className="grid grid-cols-1 gap-3">
                  <div className="flex items-center justify-between p-3 bg-emerald-50 rounded-lg">
                    <span className="text-sm font-medium text-gray-700">支給額</span>
                    <span className="font-bold text-emerald-700">{subsidy.amount}</span>
                  </div>
                ...
                <div>
                  <h4 className="text-sm font-medium text-gray-700 mb-2">対象条件</h4>
        ...
        <Card className="bg-blue-50 border border-blue-200 shadow-sm">
          <CardHeader>
            <CardTitle className="text-lg">あなたの補助金活用状況</CardTitle>
          </CardHeader>
